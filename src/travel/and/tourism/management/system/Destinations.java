...
public class Destinations extends JFrame implements Runnable{
    ...
    public void run(){
        String text[]=new String[]{"JW Marriott Hotel","Madarin Oriental Hotel","Four Season Hotel","Raddison Blue Hotel","Classsio Hotel","The Bay Club Hotel","Breeze Blow Hotel","The Taj Hotel","Happy Morning Hotel","River View Hotel"};
